...
function addBookRead() {
    const inputBookTitleRev = document.getElementById('inputBookTitle').value;
    ...
    const bookObject = generateBookObject(generatedID, inputBookTitleRev, inputBookAuthor, inputBookYear, isComplete);
...
function belumSelesaiDibaca(bookObject){
    ...
    titled.innerText = bookObject.title;
    ...
    bookContainer.append(titled, author, year);
